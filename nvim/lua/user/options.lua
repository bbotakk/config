local options = {
    ...
    numberwidth = 2, -- set nuber column width
    autochdir = true, -- vim changes cwd to the one of the buffer always. (use `:cd` to cange wd)
    ...
    guifont = "Iosevka Nerd Font 8", -- the font used in graphical neovim applications
    whichwrap = "bs<>[]hl", -- which "horizontal" keys are allowed to travel to prev/next line
    syntax = "enable",

}

-- set all options from the above alias. 
...
-- change cwd to the focused buffer always
vim.cmd [[

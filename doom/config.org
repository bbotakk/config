...
** Windows & splits
- I want windows that contain text (info or editeable) to always consistently vsplit so i can navigate them without mental overhead. But for buffers such as whichkey or menu's, they can remain on the bottom for quick access.
